...
<button
  ...
  <div style="box-shadow: 0 0 #0000, 0 0 #0000, 0 1px 2px 0 rgb(0 0 0 / 0.05); max-width: 1250px; min-height: 650px;"
    class="fixed right-0 mr-4 bg-white p-6 rounded-lg border border-[#e5e7eb] w-full h-auto">

 <!-- Chat Container -->
 <div class="pr-4 h-auto max-h-full" style="min-height: 650px; min-width: 100%; display: table;">
      <!-- Ai Stream Answer  -->
